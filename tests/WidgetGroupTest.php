...
class WidgetGroupTest extends TestCase
{
    ...
    public function testItCanDisplayWidgets()
    {
        ...
        $this->assertEquals(
            ...
            '<div id="Partoo-widget-container-2" style="display:inline" class="Partoo-widget-container">Placeholder here!' .
            '<script type="text/javascript">' .
            'var widgetTimer2 = setInterval(function() {' .
            'if (window.$) {' .
            "$('#Partoo-widget-container-2').load('" . $this->ajaxUrl('Slider', [], 2) . "');" .
    ...
    public function testWrap()
    {
        ...
        $this->assertEquals(
            ...
            '<div class=\'widget widget-1-2\'><div id="Partoo-widget-container-2" style="display:inline" class="Partoo-widget-container">Placeholder here!' .
            '<script type="text/javascript">' .
            'var widgetTimer2 = setInterval(function() {' .
            'if (window.$) {' .
            "$('#Partoo-widget-container-2').load('" . $this->ajaxUrl('Slider', [], 2) . "');" .
