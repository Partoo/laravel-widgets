...
class AsyncWidgetFactoryTest extends TestCase
{
    ...
    public function testItCanRunAsyncWidget()
    {
        ...
        $expected =
        '<div id="Partoo-widget-container-1" style="display:inline" class="Partoo-widget-container">' .
        '<script type="text/javascript">' .
        'var widgetTimer1 = setInterval(function() {' .
        'if (window.$) {' .
        "$('#Partoo-widget-container-1').load('" . $this->ajaxUrl('TestDefaultSlider') . "');" .
    ...
    public function testItCanRunAsyncWidgetWithPlaceholder()
    {
        ...
        $expected =
        '<div id="Partoo-widget-container-1" style="display:inline" class="Partoo-widget-container">Placeholder here!' .
        '<script type="text/javascript">' .
        'var widgetTimer1 = setInterval(function() {' .
        'if (window.$) {' .
        "$('#Partoo-widget-container-1').load('" . $this->ajaxUrl('Slider') . "');" .
            'clearInterval(widgetTimer1);' .
            '}' .
            '}, 100);' .
            '</script>' .
    ...
    public function testItCanRunMultipleAsyncWidgets()
    {
        ...
        $expected =
        '<div id="Partoo-widget-container-2" style="display:inline" class="Partoo-widget-container">' .
        '<script type="text/javascript">' .
        'var widgetTimer2 = setInterval(function() {' .
        'if (window.$) {' .
        "$('#Partoo-widget-container-2').load('" . $this->ajaxUrl('TestDefaultSlider', [], 2) . "');" .
    ...
    public function testItCanRunAsyncWidgetWithAdditionalParams()
    {
        ...
        'var widgetTimer1 = setInterval(function() {' .
        'if (window.$) {' .
        "$('#Partoo-widget-container-1').load('" . $this->ajaxUrl('TestWidgetWithParamsInRun', $params) . "');" .
            'clearInterval(widgetTimer1);' .
            '}' .
            '}, 100);' .
            '</script>' .
    ...
    public function testItCanRunNestedAsyncWidget()
    {
        ...
        'var widgetTimer1 = setInterval(function() {' .
        'if (window.$) {' .
        "$('#Partoo-widget-container-1').load('" . $this->ajaxUrl('Profile\TestNamespace\TestFeed') . "');" .
            'clearInterval(widgetTimer1);' .
            '}' .
            '}, 100);' .
            '</script>' .
    ...
    public function testItCanRunAsyncWidgetWithoutJquery()
    {
        ...
        'xhr.open("GET", "' . $this->ajaxUrl('TestDefaultSlider') . '", true);' .
            ...
            'var container = document.getElementById("Partoo-widget-container-1");' .
