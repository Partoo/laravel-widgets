...
return [
     ...
     */
    'widget_stub' => 'vendor/Partoo/laravel-widgets/src/Console/stubs/widget.stub',

    /*
     * Relative path from the base directory to a plain widget stub.
     */
    'widget_plain_stub' => 'vendor/Partoo/laravel-widgets/src/Console/stubs/widget_plain.stub',
];
