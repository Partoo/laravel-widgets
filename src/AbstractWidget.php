...
abstract class AbstractWidget
{
    ...
    /**
     * Should widget params be encrypted before sending them to /Partoo/load-widget?
    ...
    public function container()
    {
        return [
            'element' => 'div',
            'attributes' => 'style="display:inline" class="Partoo-widget-container"',
        ];
    }
    ...
    {
        return 'Partoo.widgets.' . serialize($params);
    }
